...
Attacking is simple in Heroband. If you move into a creature, you attack it.
...
Luckily, Heroband automatically keeps track of your experiences with a
...
lib/user in Windows, Documents/Angband in macOS).  Some user paths still retain
legacy Angband names for compatibility.
...
normal weapon would be '(+0,+0)'. Many weapons in Heroband have bonuses to
hit and/or to damage.

.. index::
   single: blows; upper limit

Heroband assumes that your youth in the rough environment near the dungeons
...
vital for surviving the deeper levels of Heroband.
